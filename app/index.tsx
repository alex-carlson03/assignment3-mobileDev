...
const signupSchema= z.object({
  ...
  phoneNum:z.string().regex(/^\d{10}$/, "Phone number must be 10 digits long"),
})
  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        />
        {errors.phoneNum && <Text style={styles.error}>{errors.phoneNum.message}</Text>}
        ...
        {errors.password && <Text style={styles.error}>{errors.password.message}</Text>}
         <Text style={styles.passwordCriteria}>
          Password must be at least 8 characters long, contain at least one special character, one uppercase letter, and one lowercase letter.
          </Text> 
        </View> 
